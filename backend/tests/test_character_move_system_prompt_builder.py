...
from app.builders.character_move_system_prompt_builder import (
...
class TestCharacterMoveSystemPromptBuilder:
    ...
    def sample_assistant_configs(self):
        ...
        return [
            ...
            {
                "title": "constraints",
                "value": ["No harmful content", "Stay in character"],
            },
        ]
    ...
    def sample_character_config(self):
        ...
        return {
            ...
            "value": [
                ...
                {
                    "title": "background",
                    "value": ["Former scientist", "Lives in a magical world"],
                },
                {
                    "title": "abilities",
                    "value": ["Spell casting", "Potion brewing", "Research"],
                },
            ],
        }
    ...
    def sample_location_config(self):
        ...
        return {
            ...
            "value": [
                ...
                {
                    "title": "description",
                    "value": "A vast library filled with mystical tomes",
                },
                {"title": "atmosphere", "value": "Quiet and mysterious"},
                {
                    "title": "notable_features",
                    "value": [
                        "Floating books",
                        "Glowing crystals",
                        "Ancient artifacts",
    ...
    def test_with_assistant_configs_returns_self(
        self, builder, sample_assistant_configs
    ):
    ...
    def test_with_assistant_configs_adds_config(
        self, builder, sample_assistant_configs
    ):
    ...
    def test_build_with_all_configs(
        self,
        builder,
        sample_assistant_configs,
        sample_character_config,
    ...
    def test_get_title_value_missing_title(self, builder):
        ...
        with patch(
            "app.builders.character_move_system_prompt_builder.logger"
        ) as mock_logger:
            title, value = builder._get_title_value(item)
    ...
    def test_get_character_name_valid_config(self, builder):
        ...
        character_config = {"variables": {"name": "TestCharacter"}}
    ...
    def test_complex_nested_structure(self, builder):
        ...
        complex_config = {
            ...
            "value": [
                ...
                {
                    "title": "attributes",
                    "value": ["Intelligence: High", "Wisdom: Medium"],
                },
