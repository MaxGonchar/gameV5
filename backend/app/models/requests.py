...
class CreateStoryRequest(BaseModel):
    ...
    companion_name: str = Field(..., min_length=1, description="User's name/preferred address")
    companion_description: str = Field(..., min_length=1, description="User character description/background")
    companion_context: str = Field(..., min_length=1, description="Background context/world information")
    meeting_location_description: str = Field(..., min_length=1, description="Description of the meeting location")
