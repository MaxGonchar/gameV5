...
from ..core.constants import (
    CHARACTERS_DIR_NAME, LOCATIONS_DIR_NAME, STORIES_DIR_NAME, 
    CHAT_HISTORY_DIR_NAME, HISTORY_FILE_NAME, CHAT_HISTORY_FILE_NAME,
    CHARACTER_FILE_NAME, META_FILE_NAME
)
...
class PathManager:
    ...
    @staticmethod
    def get_character_file(character_id: str) -> str:
    ...
    @staticmethod
    def get_meta_file() -> str:
        """Get the global meta file path."""
        return f"{settings.DATA_BASE_DIR}/{META_FILE_NAME}"
