...
class Settings(BaseModel):
    ...
    DEFAULT_STORY_CONTEXT_MODEL: str = Field(
        default_factory=lambda: os.getenv(
            "DEFAULT_STORY_CONTEXT_MODEL", "mistral-31-24b"
        ),
    ...
    DEFAULT_STORY_CONTEXT_TEMPERATURE: float = Field(
        default_factory=lambda: float(
            os.getenv("DEFAULT_STORY_CONTEXT_TEMPERATURE", "0.7")
        ),
    ...
    DATA_BASE_DIR: str = Field(
        default="data", description="Base directory for all application data"
    )
    ...
    @validator(
        ...
        "DEFAULT_STORY_CONTEXT_TEMPERATURE",
    )
    ...
    @validator(
        "DEFAULT_STORY_MODEL", "DEFAULT_SUMMARY_MODEL", "DEFAULT_STORY_CONTEXT_MODEL"
    )
