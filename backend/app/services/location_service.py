...
from app.models.responses import LocationsResponse, LocationSummary
...
class LocationService:
    ...
    async def get_locations_list(self) -> LocationsResponse:
        ...
        try:
            ...
            location_summaries = [
                LocationSummary(id=location.id, name=location.name)
            ...
            logger.error(
                f"Unexpected error fetching locations list: {e}", exc_info=True
            )
