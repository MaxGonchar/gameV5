...
### Example
The description of the character like if they are telling about to themselves. This should be written in the character's own voice and perspective, using "You" statements to reflect how they see themselves and their identity. This section should capture the essence of who they are, what drives them, and how they perceive their place in the world. It should be consistent with the character's background, personality, and communication patterns.
Do stressing on next points:
...
```md
...
Core mind settings are the fundamental psychological traits, fears, needs, and sensitivities that define the character's internal world and drive their behavior. These settings should be deeply rooted in the character's background and personality, providing a clear framework for how they perceive and react to the world around them. They serve as the foundation for understanding the character's motivations, emotional responses, and decision-making processes in various situations.
For consistency it must be written in the character's own style. Each setting should be described in a way that reflects the character's unique perspective and voice in scope of their background and personality and own reality understanding.
### Example
```md
...
All memories should sound like character recalls to to themselves, saying "You..., Your..., When you..." and so on.
This will help the LLM generate responses that are consistent with the character's past experiences and emotional history, adding depth and authenticity to their behavior in the roleplay.
### Example
```md
